...
<div class="main_section">
                  ...
                  <li class="left clearfix">
                     ...
                     <div class="chat-body clearfix">
                        ...
                        <a href="<?= site_url('Messaging/add/'.$part->id); ?>">
                           <strong class="primary-font"><?php echo $part->first_name.' '.$part->last_name; ?></strong> <strong class="pull-right">
                           <?= date('Y-m-d H:i:s', $part->last_login )?></strong>
                           </a>
                        </div>
                     </div>
                  </li>
  ...
  <button class="dropdown-toggle" type="button" id="dropdownMenu1" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <span class="caret"></span>
		 ...
		 <div class="chat_bottom"><button type="submit" value="Submit" class="pull-left upload_btn"><i class="fa fa-cloud-upload" aria-hidden="true"></i></button>
