...
<div class="body-content clearfix" >
      ...
      ?>
            <div class="form-group">
               ...
               <select class=form-control name=location id=country onchange='change_country(this.value);'>";
                ?>
         ...
         <?php echo form_submit('submit', lang('create_user_submit_btn'),'class="btn btn-theme btn-success pull-right"');?>
        </div>
       ...
       <?php echo form_close();?><!-- form login -->
            ...
            <div class="text-center color-white">By creating an account, you agree to Our <br/><a href="#" class="link-white"><strong>Terms of Service</strong></a> and consent to our <a href="#" class="link-white"><strong>Privacy Policy</strong></a>.</div>
          </div>
        </div>
