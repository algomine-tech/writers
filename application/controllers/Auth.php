  ...
  public function dashboard()
	{
		...
		else
		{
			...
			$this->render_page('theme/dashboard', $this->data);
		}
	}
	...
	public function change_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			// render
			$this->render_page('theme/auth/change_password', $this->data);
		}
		else
		{
	...
	public function forgot_password()
	{
		...
		if ($this->form_validation->run() == false)
		{
			...
			$this->data['message'] = (validation_errors()) ? validation_errors() : $this->session->flashdata('message');
			$this->render_page('theme/auth/forgot_password', $this->data);
		}
		else
		{
	...
	public function reset_password($code = NULL)
	{
		...
		if ($user)
		{
			...
			if ($this->form_validation->run() == false)
			{
				...
				// render
				$this->render_page('theme/auth/reset_password', $this->data);
			}
			else
			{
	...
	public function deactivate($id = NULL)
	{
		...
		if ($this->form_validation->run() == FALSE)
		{
			...
			$this->render_page('theme/auth/deactivate_user', $this->data);
		}
		else
		{
	...
	public function populate_state($id)
    {
        $id = $this->input->post('id');
        echo(json_encode($this->country_model->get_state($id)));
    }

    public function populate_city()
    {
        $id = $this->input->post('id');
        echo(json_encode($this->country_model->get_city($id)));
    }
	...
	public function create_user()
    {
        ...
        $this->form_validation->set_rules('last_name', 'Other names', 'required');
        ...
        else
        {
            ...
            $this->render_page('theme/auth/create_user', $this->data);
        }
    }
	...
	public function edit_user($id)
	{
		...
		$this->data['location'] = array(
			...
			'id'    => 'location',
			'type'  => 'text',
			'value' => $this->form_validation->set_value('company', $user->location),
			'class' => 'form-control'
		);
		...
		$this->render_page('theme/auth/edit_user', $this->data);
	}
	...
	public function create_group()
	{
		...
		else
		{
			...
			$this->render_page('theme/auth/create_group', $this->data);
		}
	}
	...
	public function edit_group($id)
	{
		...
		$this->render_page('theme/auth/edit_group', $this->data);
	}
